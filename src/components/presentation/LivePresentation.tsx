...
import { Media, Song, PresentationContentItem } from "../../types";
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-10 w-10 bg-black/50"
                      onClick={handlePrevious} // Changed from handleMediaSeekBackward
                    >
                    ...
                    {selectedItem &&
                      ...
                      (selectedItem as Song | PresentationContentItem).slides && // Corrected typo
                      (selectedItem as Song | PresentationContentItem).slides // Corrected typo
                        .length > 1 && (
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-10 w-10 bg-black/50"
                          onClick={previousSlide} // Destructured from store
                          disabled={currentPresentationSlideIndex === 0} // Corrected typo and destructured
                        >
                    ...
                    {selectedItem &&
                      ...
                      (selectedItem as Song | PresentationContentItem).slides // Corrected typo
                        ...
                        <Button
                          ...
                          size="icon"
                          className="h-10 w-10 bg-black/50"
                          onClick={nextSlide} // Destructured from store
                          disabled={
                            currentPresentationSlideIndex === // Corrected typo and destructured
                            (selectedItem as Song | PresentationContentItem) // Corrected typo
                              .slides.length -
                              1
                          }
                        >
                    ...
                    <Button
                      ...
                      size="icon"
                      className="h-10 w-10 bg-black/50"
                      onClick={handleNext} // Changed from handleMediaSeekForward
                    >
