...
function createWindow() {
  ...
  const mainWindow = new BrowserWindow({
    ...
    height: 600,
    webPreferences: {
      // preload: path.join(__dirname, "preload.js"), // if you have a preload script (file does not exist)
  ...
  if (!app.isPackaged) {
    ...
    mainWindow.loadURL("http://localhost:5173"); // Ensure this port matches your Vite config
    // Open the DevTools.
